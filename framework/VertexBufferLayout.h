...
class VertexBufferLayout {
    ...
    public:
        ...
        void Push<float>(unsigned int count){ 
            ...
            this->mStride += VertexBufferElement::GetSizeOfType(GL_FLOAT);
        ...
        void Push<unsigned int>(unsigned int count)
        {
            ...
            this->mStride += VertexBufferElement::GetSizeOfType(GL_UNSIGNED_INT);
        }

        template<>
        void Push<unsigned char>(unsigned int count) { 
            this->mElements.push_back((VertexBufferElement){GL_UNSIGNED_BYTE, count, GL_TRUE});
            this->mStride += VertexBufferElement::GetSizeOfType(GL_UNSIGNED_BYTE);
        }
